...
async function setNewStatsPlayer(data, player1Nickname, player2Nickname) {
  let arrPlayers = [];
...
async function setDeleteStatsPlayer(data, player1Nickname, player2Nickname) {
  let arrPlayers = [];
...
export { setNewStatsPlayer, setDeleteStatsPlayer };
